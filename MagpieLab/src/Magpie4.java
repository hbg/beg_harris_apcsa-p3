...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "me") > findKeyword(statement, "you") && findKeyword(statement, "you") != -1) {
		...
		else if (findKeyword(statement, "Star Wars") >=0 || findKeyword(statement, "IN-N-OUT") >=0) {
