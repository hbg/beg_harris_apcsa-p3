...
public class Picture extends SimplePicture 
{
  ...
  public void myCollage() {
	  Picture flower1 = new Picture("src/arch.jpg");
	    Picture flower2 = new Picture("src/dundm.png");
	    flower1.mirrorHorizontal();
	    flower1.grayscale();
	    this.copy(flower1,0,50);
	    this.copy(flower2,100,50);
	    this.copy(flower1,69,0);
	    Picture flowerNoBlue = new Picture(flower2);
	    flowerNoBlue.zeroBlue();
	    this.copy(flowerNoBlue,12,0);
	    this.copy(flower1,45,0);
